...
<i class="bi bi-download"></i> [Download TEC campaign finance data](tec-totals-preclean.xlsx){download="data/tec-totals-preclean.xlsx"}
:::
...
1. Scroll down the Candidate facets to find "Citizens For Joe Crabb (DISSOLVED)".
...
1. Set your Text filter to "Friends of" so we can see them, but don't fix them yet. We'll instead edit all the rows at once using Transform.
1. Click on the Candidate dropdown and go to Edit cells > **Transform**:
