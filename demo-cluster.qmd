...
<i class="bi bi-download"></i> [Download RI PPP data](data/ppp-less150-ri.csv){download="data/ppp-less150-ri.csv"}
:::
...
1. Launch OpenRefine if not already open. If you do have it open, click on the OpenRefine log at the top-left to get to the "home" page.
